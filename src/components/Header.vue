<template>
    ...
    <nav class="flex items-center w-full flex-wrap bg-teal p-6">
        <div class="flex flex-wrap items-center justify-between flex-no-shrink text-white w-full mr-6">
            ...
            <div class="block">
                <button @click="toggle" class="relative flex items-center px-4 py-2 rounded-full border border-white cursor-pointer">
                    <svg
                        class="w-6 h-6 text-white transition-transform duration-500"
        ...
        <div @click="toggle" :class="[open ? 'max-h-screen opacity-100': 'max-h-0 opacity-0 hidden pointer-events-none']" class="flex flex-col text-sm flex-grow lg:flex-grow lg:flex sm:flex sm:flex-grow xs:flex xs:flex-grox items-start transition-all duration-1000 ease-in-out">
            <div class="inline-block">
                <a href="#profile" @click.prevent="scrollToSection('profile')" class="no-underline mt-5 text-teal-lighter hover: text-white mr-4 flex flex-wrap items-center justify-center icon-shake">
            ...
            <div class="inline-block">
                <a href="#workExperiences" @click.prevent="scrollToSection('workExperiences')" class="no-underline mt-5 text-teal-lighter hover: text-white mr-4 flex flex-wrap items-center justify-center icon-shake">
                    <div class="w-10 h-10 mx-8 flex items-center justify-center border border-white-800 rounded-full">
                        <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path fill="white" d="M184 48l144 0c4.4 0 8 3.6 8 8l0 40L176 96l0-40c0-4.4 3.6-8 8-8zm-56 8l0 40L64 96C28.7 96 0 124.7 0 160l0 96 192 0 128 0 192 0 0-96c0-35.3-28.7-64-64-64l-64 0 0-40c0-30.9-25.1-56-56-56L184 0c-30.9 0-56 25.1-56 56zM512 288l-192 0 0 32c0 17.7-14.3 32-32 32l-64 0c-17.7 0-32-14.3-32-32l0-32L0 288 0 416c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-128z"/>
                        </svg>
                    </div>
                    <span class="ml-2 font-bold text-md text-center">
            ...
            <div class="inline-block">
                <a href="#education" @click.prevent="scrollToSection('education')" class="no-underline block mt-5 text-teal-lighter hover: text-white mr-4 flex flex-wrap items-center justify-center icon-shake">
                    <div class="w-10 h-10 mx-8 flex items-center justify-center border border-white-800 rounded-full">
            ...
            <div class="inline-block">
                <a href="#skills" @click.prevent="scrollToSection('skills')" class="no-underline block mt-5 text-teal-lighter hover: text-white mr-4 flex flex-wrap items-center justify-center icon-shake">
                    <div class="w-10 h-10 mx-8 flex items-center justify-center border border-white-800 rounded-full">
                        <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <div class="inline-block">
                <a href="#interests" @click.prevent="scrollToSection('interests')" class="no-underline block mt-5 text-teal-lighter hover: text-white mr-4 flex flex-wrap items-center justify-center icon-shake">
                    <div class="w-10 h-10 mx-8 flex items-center justify-center border border-white-800 rounded-full">
                        <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            <div class="inline-block">
                <a href="#contact" @click.prevent="scrollToSection('contact')" class="no-underline block mt-5 text-teal-lighter hover: text-white mr-4 flex flex-wrap items-center justify-center icon-shake">
                    <div class="w-10 h-10 mx-8 flex items-center justify-center border border-white-800 rounded-full">
                        <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
